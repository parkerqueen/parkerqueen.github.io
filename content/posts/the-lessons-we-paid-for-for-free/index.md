+++
title = "The lessons we paid for, for free!"
date = "2025-01-27"
author = "Soban Raza"
description = "Four years of running a tech services firm condensed into hard-won lessons about messiahs, fundamentals, and the people business."
+++
...
![Competitor search](competitor-search.avif)
...
![Definite optimism](definite-optimism.avif)
...
![Tried so hard](tried-so-hard.avif)
...
- The desire to want to offer everything under the sun (custom web dev, AI automation, blockchain technology, resource augmentation, digital transformation etc.).
...
![Fancy artwork](fancy-artwork.avif)
